...
{	
	...
	public class DamageOnTouch : CorgiMonoBehaviour 
	{
		...
		protected virtual void ApplyDamageTakenKnockback()
		{
			...
			{
				_knockbackForce.x = DamageTakenKnockbackForce.x;
				...
				_knockbackForce.y = DamageTakenKnockbackForce.y;
		...
		protected virtual void OnDrawGizmos()
		{
			...
			if ((_boxCollider2D != null) && _boxCollider2D.enabled)
			{
				...
				Gizmos.matrix = _boxCollider2D.transform.localToWorldMatrix;
				Gizmos.DrawCube(_boxCollider2D.offset, _boxCollider2D.size);
